...
router.get("/deleteBuyer/:id", isAuth, sessionExit, supervisorController.getDeleteBuyer);
...
router.post("/deleteBuyer/:id", isAuth, sessionExit, supervisorController.postDeleteBuyer);
